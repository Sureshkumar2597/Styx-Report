...
` +
    ...
    var zl = {
      ...
      fu = null;
    function pu() {
      return W & 2 && q !== 0 ? q & -q : D.T === null ? dt() : dd();
    }
    function mu() {
      if (Yl === 0)
        if (!(q & 536870912) || M) {
...
var b = { some: 0, all: 1 };
function x(e, t, { root: n, margin: r, amount: i = `some` } = {}) {
  let a = y(e),
    o = new WeakMap(),
    s = new IntersectionObserver(
      ...
      { root: n, rootMargin: r, threshold: typeof i == `number` ? i : b[i] },
    );
  ...
  ie = [
    {
      sev: `critical`,
      badge: `Critical`,
      title: `939 infostealer log hits against ATB's core online banking login endpoint`,
    ...
    },
    {
      sev: `medium`,
      badge: `Medium`,
      title: `Live third-party session cookies found on infected atb.com machines`,
  ...
  O = [
    {
      ...
      teaser: `ATB Financial's composite risk score, benchmarked against financial-services peers and calculated across 50+ signal categories — delivered in your emailed report.`,
      redactWidths: [90, 70],
    },
    {
      title: `TLS/SSL Certificate Health`,
      teaser: `Full inventory of expired, self-signed and misconfigured certificates across every discovered atb.com subdomain — delivered in your emailed report.`,
      redactWidths: [85, 60, 75],
    },
    {
      title: `Third-Party Data Breach Exposure`,
      teaser: `Complete breach history for atb.com email addresses — source, date, severity and record counts — delivered in your emailed report.`,
      redactWidths: [92, 80, 65],
    },
    {
      title: `Brand Impersonation & Lookalike Domains`,
      teaser: `All typosquats, fake social accounts and phishing infrastructure impersonating the ATB brand, ranked by severity — delivered in your emailed report.`,
      redactWidths: [70, 95, 55],
    },
    {
      title: `DNS & Email Authentication (SPF/DKIM/DMARC)`,
      teaser: `SPF, DKIM and DMARC configuration status across every atb.com mail-sending domain — delivered in your emailed report.`,
      redactWidths: [60, 60],
    },
    {
      title: `Malware & Exploit Blocklist Status`,
      teaser: `Any ATB-linked infrastructure currently flagged on active threat intelligence blocklists, with IP and hostname detail — delivered in your emailed report.`,
      redactWidths: [80, 50, 68],
    },
  ];
function le({ target: e, suffix: t = ``, className: n, style: r }) {
  let i = (0, S.useRef)(null),
    a = C(i, { amount: 0.4, once: !0 }),
    [o, s] = (0, S.useState)(0);
  return (
    (0, S.useEffect)(() => {
      if (!a) return;
      let t = performance.now(),
        n = 0;
      function r(i) {
        let a = Math.min(1, (i - t) / 1400),
          o = 1 - (1 - a) ** 3;
        (s(Math.round(e * o)), a < 1 && (n = requestAnimationFrame(r)));
      }
...
function ue({ pct: e }) {
  ...
  return (0, T.jsx)(`div`, {
    ...
    children: (0, T.jsx)(`div`, {
      className: `fam-fill`,
      ref: t,
      style: { width: C(t, { amount: 0.3, once: !0 }) ? `${e}%` : `0%` },
    }),
  });
}
function de({ data: e }) {
  let t = (0, S.useRef)(null),
    ...
    i = Math.max(...e.map((e) => e.users)) * 1.15,
    a = 668 / e.length,
    o = a * 0.28,
    s = (e, n) => {
      let i = t.current?.getBoundingClientRect();
      i && r({ x: e.clientX - i.left, y: e.clientY - i.top, text: n });
    },
    c = () => r(null);
  return (0, T.jsxs)(`div`, {
    ...
    children: [
              ...
              `g`,
              {
                children: [
                  (0, T.jsx)(`rect`, {
                    ...
                    fill: `#ff9301`,
                    className: `tt-bar`,
                    onMouseMove: (t) => s(t, `${e.year} · Users: ${e.users}`),
                    onMouseLeave: c,
                  }),
                  (0, T.jsx)(`rect`, {
                    x: n + a * 0.54,
                    ...
                    className: `tt-bar`,
                    onMouseMove: (t) =>
                      s(t, `${e.year} · Employees: ${e.employees}`),
                    onMouseLeave: c,
                  }),
                  (0, T.jsx)(`text`, {
                    x: n + a / 2,
      ...
      (0, T.jsx)(`div`, {
        ...
        id: `chartTooltip`,
        style: { left: n ? n.x : 0, top: n ? n.y : 0, opacity: +!!n },
        children: n?.text,
      }),
    ],
  });
...
function fe() {
  let [e, t] = (0, S.useState)(!1),
    ...
    [x, C] = (0, S.useState)(``),
    [w, fe] = (0, S.useState)(``),
    [k, A] = (0, S.useState)(() => O.map(() => !1)),
    pe = (0, S.useRef)(null),
    me = (0, S.useRef)(null),
    he = (0, S.useRef)(null);
  (0, S.useEffect)(() => {
    let e = [`overview`, `findings`, `timeline`, `families`, `unlock`]
        .map((e) => document.getElementById(e))
        .filter(Boolean),
      t = new IntersectionObserver(
        (e) => {
          e.forEach((e) => {
            e.isIntersecting && r(e.target.id);
          });
        },
  ...
  let ge = ce(oe),
    ...
    ye = () => {
      pe.current?.scrollIntoView({ behavior: `smooth`, block: `center` });
      let e = me.current;
      e && (e.classList.remove(`attn`), e.offsetWidth, e.classList.add(`attn`));
    };
    ...
    children: [
          ...
          children: [
            (0, T.jsxs)(`div`, {
              ...
              children: [
                (0, T.jsxs)(`div`, {
                  className: `logo-mark`,
                  children: [`STY`, (0, T.jsx)(`span`, { children: `X` })],
                }),
                (0, T.jsxs)(`div`, {
                  className: `logo-sub`,
                  children: [
            ...
            (0, T.jsxs)(`div`, {
              ...
              children: [
                (0, T.jsx)(`button`, {
                  className: `top-cta${l ? ` done` : ``}`,
                  id: `topCta`,
                  onClick: l ? void 0 : ye,
                  children: l ? `Report Unlocked ✓` : `Unlock Full Report`,
                }),
                (0, T.jsx)(`button`, {
                  className: `menu-btn`,
                  id: `menuBtn`,
        ...
        children: (0, T.jsxs)(`div`, {
          ...
          children: [
            (0, T.jsxs)(`div`, {
              ...
              children: [
                (0, T.jsx)(`span`, { className: `live-dot` }),
                ` Live monitoring · Free preview · No login required`,
              ],
            }),
            (0, T.jsxs)(`div`, {
              className: `hero-grid`,
                ...
                (0, T.jsxs)(`div`, {
                  children: [
                    (0, T.jsx)(`p`, {
                      ...
                      children: `External Cyber Risk Assessment`,
                    }),
                    (0, T.jsx)(`h1`, {
                      className: `hero-title`,
                      children: `ATB Financial`,
                    }),
                    (0, T.jsxs)(`div`, {
                      className: `hero-meta`,
                      children: [
                        `Financial Services \xA0·\xA0 `,
                        (0, T.jsx)(`strong`, { children: `7 July 2026` }),
                        ` \xA0·\xA0 Target: atb.com`,
                      ],
                    }),
                    (0, T.jsxs)(`p`, {
                      className: `hero-desc`,
                      children: [
                        `A domain intelligence sweep of `,
                        (0, T.jsx)(`strong`, { children: `atb.com` }),
                        ` surfaced active exposures — all sourced from infostealer malware logs, with zero access to internal ATB systems.`,
                      ],
                    }),
                  ],
                }),
            ...
            (0, T.jsxs)(`div`, {
              ...
              children: [
                <div className="preview-strip">
                  ...
                  intelligence for <strong>{data.domain}</strong>. Scroll to
      ...
      (0, T.jsxs)(`section`, {
        ...
        children: [
          (0, T.jsx)(`p`, {
            className: `eyebrow`,
            children: `What we found — from entirely outside your network`,
          }),
          (0, T.jsx)(`h2`, {
            className: `section-title`,
            children: `Seven signals, one exposed perimeter`,
          }),
          (0, T.jsx)(`p`, {
            className: `section-sub`,
            children: `This is what's already circulating on stealer log marketplaces today — no credentials, penetration testing, or internal access required to surface it.`,
          }),
          (0, T.jsx)(`ul`, {
            ...
            children: te.map((e, t) =>
              (0, T.jsxs)(
                ...
                {
                  children: [
                    (0, T.jsx)(`span`, { className: `marker`, children: `▪` }),
                    (0, T.jsx)(`span`, {
                      className: `txt`,
      ...
      (0, T.jsxs)(`section`, {
        ...
        children: [
          (0, T.jsx)(`p`, {
            className: `eyebrow`,
            children: `Active infostealer spotlight`,
          }),
          (0, T.jsx)(`h2`, {
            className: `section-title`,
            children: `Online banking & shop portals are actively targeted`,
          }),
          (0, T.jsxs)(`div`, {
            className: `spot-box`,
            children: [
              (0, T.jsxs)(`div`, {
                ...
                children: [
                  (0, T.jsx)(`p`, {
                    ...
                    children: `1,183+ customers/users compromised — online banking & shop portals targeted`,
                  }),
                  (0, T.jsx)(`span`, {
                    className: `badge badge-active`,
                    children: `Active Infostealer`,
                  }),
                ],
              }),
              (0, T.jsx)(`p`, {
                className: `spot-meta`,
                children: `Source: Styx Intelligence \xA0·\xA0 Scope: 3+ employees, 1,183+ users, 24+ third-party credentials \xA0·\xA0 Timeline: active since 2022, 166+ new machines already in 2026`,
              }),
              (0, T.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, T.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, T.jsx)(`div`, {
                        className: `mini-stat-label`,
                        children: `Hits on login endpoint`,
                      }),
                    ],
                  }),
                  (0, T.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, T.jsx)(`div`, {
                        className: `mini-stat-label`,
                        children: `Employees compromised`,
                      }),
                    ],
                  }),
                ],
                        ...
                        (0, T.jsxs)(
                          `tr`,
                          {
                            children: [
                              ...
                              (0, T.jsx)(`td`, { children: e.scope }),
                              (0, T.jsx)(`td`, {
                                className: `num`,
                                children: e.occurrences,
                              }),
                            ],
                          },
                          e.url,
              ...
              (0, T.jsx)(`p`, {
                className: `foot-note`,
                children: `Showing top-occurrence URLs only. Full URL breakdown — including identity.auth.atb.com, shop.atb.com/login and login.atb.com/idp/SSO.saml2 — available on request. Click a column header to sort.`,
              }),
            ],
          }),
        ],
      ...
      (0, T.jsxs)(`section`, {
        ...
        id: `timeline`,
        children: [
          (0, T.jsx)(`p`, { className: `eyebrow`, children: `5-year trend` }),
          (0, T.jsx)(`h2`, {
            className: `section-title`,
            children: `A persistent exposure, not a one-off incident`,
          }),
          (0, T.jsx)(`p`, {
            className: `section-sub`,
            children: `Compromised machines tied to atb.com by year, split between employees and users. 166+ new machines already compromised in 2026 — and the year isn't over.`,
          }),
          (0, T.jsxs)(`div`, {
      ...
      (0, T.jsxs)(`section`, {
        ...
        children: [
          (0, T.jsx)(`p`, {
            className: `eyebrow`,
            children: `Top findings — free preview`,
          }),
          (0, T.jsx)(`h2`, {
            className: `section-title`,
            children: `Ranked by severity`,
          }),
          (0, T.jsx)(`p`, {
            className: `section-sub`,
            children: `Filter to focus on what matters most right now.`,
          }),
          (0, T.jsx)(`div`, {
            ...
            children: ae.map((e) =>
              (0, T.jsx)(
                `button`,
                {
                  className: `filter-btn${i === e.key ? ` active` : ``}`,
                  "data-filter": e.key,
                  onClick: () => a(e.key),
                  children: e.label,
                },
          ...
          (0, T.jsx)(`div`, {
            ...
            children: ie.map((e, t) =>
              (0, T.jsxs)(
                `div`,
                {
                  className: `finding${i !== `all` && e.sev !== i ? ` hide` : ``}`,
                  "data-sev": e.sev,
                  children: [
                    (0, T.jsx)(`span`, {
                      className: `sev-badge sev-${e.sev}`,
                      children: e.badge,
                    }),
                    (0, T.jsxs)(`div`, {
                      children: [
      ...
      (0, T.jsxs)(`section`, {
        ...
        children: [
          (0, T.jsx)(`p`, {
            className: `eyebrow`,
            children: `Credential & device hygiene`,
          }),
          (0, T.jsx)(`h2`, {
            className: `section-title`,
            children: `Where the weak points sit`,
          }),
          (0, T.jsxs)(`div`, {
            className: `two-col`,
            ...
            children: [
              (0, T.jsxs)(`div`, {
                ...
                children: [
                  (0, T.jsx)(`div`, {
                    ...
                    children: `Password Strength — Employees (3+)`,
                  }),
                  (0, T.jsxs)(`div`, {
                    className: `donut-row`,
                    children: [
              ...
              (0, T.jsxs)(`div`, {
                ...
                children: [
                  (0, T.jsx)(`div`, {
                    className: `panel-label`,
                    children: `Password Strength — Users (1,811+)`,
                  }),
                  (0, T.jsxs)(`div`, {
                    className: `donut-row`,
                    children: [
          ...
          (0, T.jsxs)(`div`, {
            ...
            children: [
              (0, T.jsx)(`div`, {
                className: `panel-label`,
                children: `Employee Device Hygiene`,
              }),
              (0, T.jsxs)(`div`, {
                className: `two-col`,
                children: [
                  (0, T.jsxs)(`div`, {
                    children: [
                      (0, T.jsx)(`p`, {
                        ...
                        children: `Anti-Virus Status`,
                      }),
                      (0, T.jsxs)(`div`, {
                        className: `hygiene-bar`,
                        children: [
                          (0, T.jsx)(`div`, {
                            className: `hygiene-seg`,
                            style: { width: `50%`, background: `var(--good)` },
                            children: `Premium 50%`,
                          }),
                          (0, T.jsx)(`div`, {
                            className: `hygiene-seg`,
                            style: { width: `50%`, background: `var(--high)` },
                            children: `Free 50%`,
                          }),
                        ],
                      }),
                      (0, T.jsxs)(`div`, {
                        className: `hygiene-legend`,
                        children: [
                          (0, T.jsxs)(`span`, {
                            children: [
                              (0, T.jsx)(`span`, {
                  ...
                  (0, T.jsxs)(`div`, {
                    children: [
                      (0, T.jsx)(`p`, {
                        ...
                        children: `Infected Sensitive Application`,
                      }),
                      (0, T.jsxs)(`p`, {
                        className: `app-note`,
                        children: [
                          `Compromised employee credentials tagged against `,
                          (0, T.jsx)(`strong`, { children: `sso` }),
                          ` — despite half of employees running premium AV, infostealer malware still reached SSO-adjacent credentials.`,
                        ],
                      }),
                    ],
                  }),
      ...
      (0, T.jsxs)(`section`, {
        ...
        children: [
          (0, T.jsx)(`p`, {
            className: `eyebrow`,
            children: `Malware breakdown`,
          }),
          (0, T.jsx)(`h2`, {
            className: `section-title`,
            children: `Infostealer families identified across compromised machines`,
          }),
          (0, T.jsxs)(`div`, {
            className: `panel`,
            id: `famChart`,
            children: [
              ...
              (0, T.jsx)(`p`, {
                className: `foot-note`,
                children: `Generic Stealer, Lumma and RedLine together account for ≈78% of identified compromises — the three most prolific commodity infostealer families in circulation today.`,
              }),
            ],
          }),
        ],
      ...
      (0, T.jsxs)(`section`, {
        ...
        children: [
          (0, T.jsxs)(`div`, {
            className: `locked-head`,
            children: [
              (0, T.jsxs)(`div`, {
                children: [
                  (0, T.jsx)(`p`, {
                    className: `eyebrow`,
                    children: `Included in the full assessment`,
                  }),
                  (0, T.jsx)(`h2`, {
                    className: `section-title`,
                    style: { marginBottom: 0 },
                    children: `Six more categories, currently classified`,
                  }),
                ],
              }),
              (0, T.jsx)(`span`, {
                className: `locked-count`,
                children: `Click any card, or unlock all below ↓`,
              }),
            ],
          }),
          (0, T.jsx)(`div`, {
            ...
            children: O.map((e, t) =>
              (0, T.jsxs)(
                `div`,
                {
                  className: `locked-card${k[t] ? ` unlocked` : ``}`,
                  onClick: k[t] ? void 0 : ye,
                  children: [
                    (0, T.jsx)(`span`, {
                      className: `stamp`,
                      children: `Classified`,
                    ...
                    (0, T.jsx)(`span`, {
                      className: `lc-status`,
                      children: k[t] ? `✓ Unlocked` : `🔒 Locked`,
                    }),
                    (0, T.jsx)(`div`, {
                      className: `redact-lines`,
                      children: e.redactWidths.map((e, n) =>
                        (0, T.jsx)(
                          `div`,
                          {
                            ...
                            style: {
                              width: `${e}%`,
                              height: n === 0 && t === 0 ? 22 : void 0,
                              transform: k[t] ? `scaleX(0)` : void 0,
                            },
                          },
                          n,
                        ),
            ...
            (0, T.jsxs)(`div`, {
              ...
              children: [
                (0, T.jsx)(`h3`, {
                  ...
                  children: `Unlock the Complete ATB Financial Report`,
                }),
                (0, T.jsx)(`p`, {
                  className: `unlock-sub`,
                  children: `Get the full assessment — risk score, TLS/SSL health, breach exposure, brand impersonation and DNS security — sent straight to your inbox.`,
                }),
                (0, T.jsxs)(`form`, {
                  id: `unlockForm`,
                  onSubmit: (e) => {
                ...
                (0, T.jsx)(`p`, {
                  className: `form-note`,
                  children: `No spam. One email with your complete assessment. Unsubscribe anytime.`,
                }),
              ],
            }),
            (0, T.jsxs)(`div`, {
              ...
              children: [
                (0, T.jsx)(`div`, { className: `check`, children: `✅` }),
                (0, T.jsxs)(`p`, {
                  children: [
                    `Thanks`,
                    (0, T.jsx)(`span`, { id: `successName`, children: x }),
                    ` — the six locked sections above are now marked`,
                    ` `,
                    (0, T.jsx)(`strong`, { children: `unlocked` }),
                    `. Our team will send the complete ATB Financial report to`,
                    ` `,
                    (0, T.jsx)(`strong`, {
                      id: `successEmail`,
                      style: { color: `#ffd699` },
      ...
      (0, T.jsx)(`section`, {
        ...
        children: (0, T.jsxs)(`div`, {
          ...
          children: [
            (0, T.jsx)(`p`, {
              className: `lead`,
              children: `The sections above are a partial view from an external domain intelligence sweep only.`,
            }),
            (0, T.jsx)(`p`, {
              className: `body`,
              children: `Full continuous monitoring — dark web, brand impersonation, infrastructure, compromised credentials and data leakage — is available on the Styx Intelligence platform. Happy to walk through the complete picture in a 20-minute call.`,
            }),
          ],
        }),
      }),
          ...
          children: [
            (0, T.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, T.jsx)(`p`, { children: `styxintel.com` }),
              ],
            }),
            (0, T.jsxs)(`div`, {
              className: `footer-right`,
              children: [
                (0, T.jsx)(`p`, { children: `Private & Confidential` }),
                (0, T.jsx)(`p`, {
                  children: `© 2026 Styx Intelligence. All Rights Reserved.`,
                }),
              ],
            }),
          ],
...
var k = document.getElementById(`styx-root`) || document.getElementById(`root`);
k
  ? (0, w.createRoot)(k).render(
      (0, T.jsx)(S.StrictMode, { children: (0, T.jsx)(fe, {}) }),
    )
